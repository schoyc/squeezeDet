...
class kitti_adv(imdb):
  def __init__(self, image_set=, data_path, mc):
    imdb.__init__(self, 'kitti_adv_'+image_set, mc)
    self._image_set = image_set # "adv.txt"
    self._data_root_path = data_path
    self._image_path = os.path.join(self._data_root_path, 'training_adv', 'image_2')
    self._label_path = os.path.join(self._data_root_path, 'training_adv', 'label_2')
