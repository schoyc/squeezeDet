...
def parse_mapping_ids():
    mappings = dict()
    with open('vkitti_rerendered_set.txt', 'r') as f:
        for line in f:
            data = line.strip('\n').split(' ')
...
def iterative_fgsm(dataset_root, num_iterations, param, eps=.01):
...
if __name__ == '__main__':
    out = iterative_fgsm('/home/lakshya/3D-SDN/datasets/vkitti_1.3.1_rgb/', 5, 'translate', eps=.02)
